...
var waves = [
	[	
		...
		[base_enemy, 3, 10, 3, 0.06],
		[base_enemy, 4, 10, 3, 0.06],
	],
	[	
		#wave 2
		[base_enemy, 0, 15, 2, 0.03],
		[base_enemy, 1, 15, 2, 0.03],
		[base_enemy, 2, 10, 2, 0.06],
		[base_enemy, 3, 10, 2, 0.06],
		[base_enemy, 4, 15, 2, 0.03],
	],
	[	
		#wave 1
		[base_enemy, 0, 15, 1, 0.03],
		[base_enemy, 1, 15, 1, 0.03],
		[base_enemy, 2, 15, 1, 0.03],
		[base_enemy, 3, 15, 1, 0.03],
		[base_enemy, 4, 15, 1, 0.06],
	],
]
